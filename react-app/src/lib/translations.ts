...
export const translations: Record<'en' | 'sw', Translations> = {
  en: {
    ...
    no_alerts: "You're all caught up",
    quick_add_product: 'Add Product',
    sold: 'Sold',
    more: 'More',
    stock_left_suffix: 'items left',

    // Business Management
    biz_management_title: 'Business Management',
    biz_management_subtitle: 'Manage all your businesses, branding, and currencies.',
    add_business: 'Add Business',
    total_organizations: 'Total organizations',
    no_businesses_yet: 'No businesses yet. Create your first business to start managing sales, products, and reports.',
    ...
    my_business_placeholder: 'My Business',
    creating: 'Creating...',
    saving: 'Saving...',
    save_changes: 'Save Changes',
    drag_logo_here: 'Drag logo here',
    browse_files: 'Browse Files',
    logo_upload_hint: 'PNG, JPG, SVG • Maximum 5MB',
    business_settings: 'Business Settings',
    business_id: 'Business ID',
    owner_id: 'Owner ID',
    last_updated: 'Last Updated',
    close: 'Close',
    confirm_delete_business: 'Are you sure you want to delete this business? This action cannot be undone.',
  ...
  sw: {
    ...
    alerts_actions: 'Tahadhari na Vitendo',
    top_selling_products: 'Bidhaa Zinazouzwa Zaidi',
    view_report: 'Angalia Ripoti',
    view_inventory: 'Angalia Bidhaa',
    overdue_debt: 'Deni Lililochelewa',
    vs_yesterday: 'ikilinganishwa na jana',
    no_alerts: 'Hakuna tahadhari kwa sasa',
    quick_add_product: 'Ongeza Bidhaa',
    sold: 'Zimeuzwa',
    more: 'Zaidi',
    stock_left_suffix: 'zimebaki',

    // Business Management
    biz_management_title: 'Usimamizi wa Biashara',
    biz_management_subtitle: 'Simamia biashara zako zote, chapa, na sarafu.',
    add_business: 'Ongeza Biashara',
    total_organizations: 'Jumla ya Biashara',
    no_businesses_yet: 'Huna biashara bado. Unda biashara yako ya kwanza ili kuanza kusimamia mauzo, bidhaa, na ripoti.',
    create_business: 'Unda Biashara',
    currency: 'Sarafu',
    brand_color: 'Rangi ya Chapa',
    created: 'Ilianzishwa',
    updated: 'Ilisasishwa',
    edit_business: 'Hariri Biashara',
    upload_logo: 'Pakia Nembo',
    create_new_business: 'Unda Biashara Mpya',
    business_name_label: 'Jina la Biashara *',
    my_business_placeholder: 'Biashara Yangu',
    creating: 'Inaunda...',
    saving: 'Inahifadhi...',
    save_changes: 'Hifadhi Mabadiliko',
    drag_logo_here: 'Buruta nembo hapa',
    browse_files: 'Vinjari Faili',
    logo_upload_hint: 'PNG, JPG, SVG • Upeo wa 5MB',
    business_settings: 'Mipangilio ya Biashara',
    business_id: 'Kitambulisho cha Biashara',
    owner_id: 'Kitambulisho cha Mmiliki',
    last_updated: 'Ilisasishwa Mwisho',
    close: 'Funga',
    confirm_delete_business: 'Una uhakika unataka kufuta biashara hii? Kitendo hiki hakiwezi kutenduliwa.',
    file_must_be_image: 'Faili lazima liwe picha',
    file_size_limit: 'Ukubwa wa faili lazima uwe chini ya 5MB',
    today: 'Leo',
    yesterday: 'Jana',
    ...
    all_tables: 'Majedwali Yote',
    export: 'Hamisha',
    failed_load_audit_logs: 'Imeshindwa kupakia kumbukumbu za ukaguzi',
    no_audit_logs: 'Hakuna kumbukumbu za ukaguzi',
